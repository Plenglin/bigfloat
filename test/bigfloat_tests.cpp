...
BOOST_AUTO_TEST_SUITE(bigfloat_mul)
    ...
    TEST_DBB_MULTIPLICATION_CASE(mbb0, 1.0, 2.0)
    TEST_DBB_MULTIPLICATION_CASE(mbb1, 1.0, 3.0)
    TEST_DBB_MULTIPLICATION_CASE(mbb2, 1321.0, 3.34)
    TEST_DBB_MULTIPLICATION_CASE(mbb3, 234.3, -234.123)
    TEST_DBB_MULTIPLICATION_CASE(mbb4, 2434.0, 0.0)
    TEST_DBB_MULTIPLICATION_CASE(mbb5, 0.1323, 2739.8)
    TEST_DBB_MULTIPLICATION_CASE(mbb6, 2332e-5, 3.32)
BOOST_AUTO_TEST_SUITE_END();
