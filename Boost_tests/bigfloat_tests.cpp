...
BOOST_AUTO_TEST_SUITE(bigfloat_operands)
    ...
    TEST_F_ADDITION_CASE(sf1, 0.25f, 0.5f)
    TEST_F_ADDITION_CASE(sf2, 0.625f, 0.375f)
    TEST_F_ADDITION_CASE(sf3, 0.8f, 0.6f)
    TEST_F_ADDITION_CASE(sf4, 0.937498723478932789425f, 0.91267467283412345f)
    TEST_F_ADDITION_CASE(sf5, 9e-2f, 1.23e4f)

    TEST_F_ADDITION_CASE(sf_mp1, -1.0f, 2.0f)
    TEST_F_ADDITION_CASE(sf_mp2, -2.0f, 1.0f)
    TEST_F_ADDITION_CASE(sf_pm1, 2.0f, -1.0f)
    TEST_F_ADDITION_CASE(sf_pm3, -2.0f, 1.75f)
    TEST_F_ADDITION_CASE(sf8, -0.2f, -0.9f)
BOOST_AUTO_TEST_SUITE_END();
